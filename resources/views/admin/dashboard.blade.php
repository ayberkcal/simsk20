...
@section('content')
<div class="card">
  <li class="list-group-item list-group-item-primary"><strong> D A S H B O A R D <div class="float-right">{{date('l, d F Y, h:i:s A')}}</div></strong></li>
</div>
    ...
    <div class="col-sm-6 col-md-2">
      <div class="card">
        <div class="card-body">
          ...
          <div class="text-value-lg">{{$permohonan}}</div><small class="text-muted text-uppercase font-weight-bold">Permohonan <span class="badge badge-pill badge-info"><font style="font-size: 89%; text-transform: capitalize;"> All </font></span></small>
    ...
    <div class="col-sm-6 col-md-2">
      <div class="card">
        <div class="card-body">
          ...
          <div class="text-value-lg">{{$proses}}</div><small class="text-muted text-uppercase font-weight-bold">Permohonan <span class="badge badge-pill badge-warning"><font style="font-size: 89%; text-transform: lowercase; color: black"> on process </font></span></small>
          <div class="progress progress-xs mt-3 mb-0">
