...
<div class="card">
        <div class="card-header">
            <h4 class="right_col">
              Klasifikasi <small class="text-muted">Edit Data</small>
        ...
        <div class="card-body">
            ...
            @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="klasifikasi" placeholder="ex: Kemahasiswaan" value="{{ $klasifikasi->klasifikasi }}" required/>
                    </div>
                </div>       
